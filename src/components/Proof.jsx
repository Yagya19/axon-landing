...
export default function Proof() {
  const testimonials = [
    ...
    {
      quote: "Friday night my competitor dropped their hoodie price by 22%. I found out Tuesday morning because a customer texted me asking why mine was so much more expensive. The whole weekend gone. That text message was the worst part honestly. Not the lost sales, just knowing I could have done something if I had known sooner. FARWATCH sends me that information on Friday night now. The weekend feels very different when you are the one who knows first.",
      author: "Shopify founder",
    ...
    <div id="proof" style={{ background: '#080808' }}>
      ...
      <div style={{ padding: '48px 32px', maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <p style={{
          ...
          Every founder below had the same feeling — finding out too late. FARWATCH exists so you never have that feeling again.
        </p>
