...
const NoteBox = ({ text }) => (
  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '6px', padding: '7px 9px', background: 'rgba(255,255,255,0.03)', border: '0.5px solid rgba(255,255,255,0.06)', borderRadius: '5px', marginTop: '8px' }}>
    <span style={{ fontFamily: "'DM Mono', monospace", fontSize: '10px', color: 'rgba(255,255,255,0.25)', flexShrink: 0, marginTop: '1px' }}>ℹ</span>
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '12px' }}>
            <div style={{ background: '#0a0a0a', border: `0.5px solid ${activeColor}33`, borderRadius: '8px', padding: '12px' }}>
              ...
              <NoteBox text={active.strategicNote} />
            </div>
            <div style={{ background: '#0a0a0a', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: '8px', padding: '12px' }}>
              ...
              <NoteBox text={active.tacticalNote} />
            </div>
          </div>
