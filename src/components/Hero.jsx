      ...
      >
        <defs>
          <pattern id="dots" x="0" y="0" width="26" height="26" patternUnits="userSpaceOnUse">
            <circle cx="1" cy="1" r="0.8" fill="rgba(60,120,255,0.15)" />
          </pattern>
          ...
          <radialGradient id="blueGlow" cx="85%" cy="30%" r="35%">
            <stop offset="0%" stopColor="rgba(40,100,255,0.07)" />
            <stop offset="100%" stopColor="transparent" />
          </radialGradient>
        </defs>
        ...
        <path d="M0 520 Q150 480 300 520 Q450 560 600 520 Q750 480 900 520 Q1050 560 1200 520" stroke="rgba(60,120,255,0.1)" strokeWidth="1" fill="none" />
        <path d="M0 545 Q150 510 300 545 Q450 580 600 545 Q750 510 900 545 Q1050 580 1200 545" stroke="rgba(60,120,255,0.07)" strokeWidth="0.5" fill="none" />
        <path d="M0 500 Q150 465 300 500 Q450 535 600 500 Q750 465 900 500 Q1050 535 1200 500" stroke="rgba(212,160,23,0.05)" strokeWidth="0.5" fill="none" />
        <path d="M0 565 Q150 535 300 565 Q450 595 600 565 Q750 535 900 565 Q1050 595 1200 565" stroke="rgba(60,120,255,0.05)" strokeWidth="0.5" fill="none" />

        {/* Radar rings — right edge behind terminal */}
        <circle cx="980" cy="220" r="55" stroke="rgba(60,130,255,0.12)" strokeWidth="0.8" fill="none" />
        <circle cx="980" cy="220" r="100" stroke="rgba(60,130,255,0.09)" strokeWidth="0.8" fill="none" />
        <circle cx="980" cy="220" r="145" stroke="rgba(60,130,255,0.07)" strokeWidth="0.8" fill="none" />
        <circle cx="980" cy="220" r="190" stroke="rgba(60,130,255,0.05)" strokeWidth="0.8" fill="none" />
        <circle cx="980" cy="220" r="235" stroke="rgba(60,130,255,0.03)" strokeWidth="0.8" fill="none" />

        {/* Radar crosshairs */}
        <line x1="980" y1="0" x2="980" y2="440" stroke="rgba(60,130,255,0.07)" strokeWidth="0.5" />
        <line x1="750" y1="220" x2="1200" y2="220" stroke="rgba(60,130,255,0.07)" strokeWidth="0.5" />
        <line x1="980" y1="220" x2="1150" y2="50" stroke="rgba(60,130,255,0.04)" strokeWidth="0.5" />
        <line x1="980" y1="220" x2="1150" y2="390" stroke="rgba(60,130,255,0.04)" strokeWidth="0.5" />

        {/* Signal dots on radar */}
        <circle cx="895" cy="148" r="4" fill="#E85D24" opacity="0.85" />
        <circle cx="895" cy="148" r="10" fill="#E85D24" opacity="0.15" />
        <circle cx="930" cy="295" r="3.5" fill="#378ADD" opacity="0.85" />
        <circle cx="930" cy="295" r="9" fill="#378ADD" opacity="0.15" />
        <circle cx="840" cy="255" r="3.5" fill="#D4A017" opacity="0.85" />
        <circle cx="840" cy="255" r="9" fill="#D4A017" opacity="0.15" />

        {/* Dashed connection lines */}
        <line x1="895" y1="148" x2="930" y2="295" stroke="rgba(232,93,36,0.18)" strokeWidth="0.5" strokeDasharray="3 3" />
        <line x1="930" y1="295" x2="840" y2="255" stroke="rgba(55,138,221,0.18)" strokeWidth="0.5" strokeDasharray="3 3" />
        <line x1="840" y1="255" x2="895" y2="148" stroke="rgba(212,160,23,0.18)" strokeWidth="0.5" strokeDasharray="3 3" />

        {/* Scattered blue dots — lower half */}
        <circle cx="180" cy="420" r="1.5" fill="rgba(60,120,255,0.4)" />
        <circle cx="280" cy="390" r="1" fill="rgba(60,120,255,0.3)" />
        <circle cx="380" cy="440" r="1.5" fill="rgba(60,120,255,0.35)" />
        <circle cx="480" cy="410" r="1" fill="rgba(60,120,255,0.25)" />
        <circle cx="120" cy="460" r="1" fill="rgba(60,120,255,0.2)" />
        <circle cx="220" cy="475" r="1.5" fill="rgba(60,120,255,0.3)" />
        <circle cx="330" cy="465" r="1" fill="rgba(60,120,255,0.2)" />
        <circle cx="430" cy="480" r="1.5" fill="rgba(60,120,255,0.25)" />
        <circle cx="80" cy="380" r="1" fill="rgba(60,120,255,0.15)" />
        <circle cx="550" cy="430" r="1" fill="rgba(60,120,255,0.2)" />
        <circle cx="150" cy="500" r="1" fill="rgba(60,120,255,0.15)" />
        <circle cx="350" cy="510" r="1.5" fill="rgba(60,120,255,0.2)" />
